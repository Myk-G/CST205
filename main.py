...
print("local time = " + localTime.translate({ord(':'): None}))
print("temp high = ", temperatureHigh)
print("Temp high to ASCII symbol is", hex(temperatureHigh)[2:])
print("temp low = ", temperatureLow)
print("Temp low to ASCII symbol is", hex(temperatureLow)[2:])
print("sunrise = " + sunrise.translate({ord(':'): None}))
print("sunset = " + sunset.translate({ord(':'): None}))
print("elevation = " + elevation)

localDate.translate({ord('-'): None}), localTime.translate({ord(':'): None}), hex(temperatureHigh)[2:], hex(temperatureLow)[2:],\
           sunrise.translate({ord(':'): None}), sunset.translate({ord(':'): None}), elevation

print(localDate.translate({ord('-'): None}), localTime.translate({ord(':'): None}), hex(temperatureHigh)[2:], hex(temperatureLow)[2:],\
           sunrise.translate({ord(':'): None}), sunset.translate({ord(':'): None}), elevation)
